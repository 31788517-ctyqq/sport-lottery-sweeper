...
from backend.scrapers.sources.five_hundred_selenium_scraper import FiveHundredSeleniumScraper, scrape_five_hundred_jczq_selenium


def test_selenium_five_hundred_scraper():
    """
    测试500彩票网Selenium爬虫
    """
    print("="*60)
    print("开始测试500彩票网竞彩足球爬虫 (Selenium版)")
    print("="*60)
    ...
    try:
        ...
        # 测试便捷函数
        print(f"\n🧪 测试便捷函数...")
        matches_fn = scrape_five_hundred_jczq_selenium(days=1)
...
if __name__ == "__main__":
    test_selenium_five_hundred_scraper()