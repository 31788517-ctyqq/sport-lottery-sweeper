...
async def fixed_complete_e2e_test():
    """修复后的完整端到端测试，验证数据源管理页面的所有功能"""
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.screenshot(path='fixed_complete_e2e_test_error.png')
            raise e
        finally:
            await browser.close()
...
if __name__ == "__main__":
    asyncio.run(fixed_complete_e2e_test())