// Complete integration test without mounting Vue components
...
// Import the component's methods without mounting the component
...
describe('Beidan Filter Panel - Complete Integration Tests (Without Mount)', () => {
  ...
  describe('2. UI Components Logic (Methods Testing)', () => {
    // We'll test the logic functions that would be used by the component
    it('serializes strategy correctly', () => {
