  ...
  <div class="page-container">
    ...
    <el-card class="box-card">
      <template #header>
        ...
        <el-button type="primary" size="small" @click="handleExport" style="float:right;">导出CSV</el-button>
      </template>
...
import { getStats, getData, exportData } from '@/api/crawlerIntelligence'
...
const loadData = async () => {
  ...
  kpiData.value = [
    { label: '今日抓取总数', value: stats.today_total },
    { label: '今日成功', value: stats.today_success },
    { label: '今日失败', value: stats.today_failed },
    { label: '总成功率(%)', value: stats.overall_success_rate }
  ]
...
const handleExport = async () => {
  ...
  // 真实场景会触发文件下载
  ElMessage.success(`导出链接：${res.data.download_url}`)
}
