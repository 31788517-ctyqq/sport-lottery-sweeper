<template>
  <div class="system-logs-container">
    <el-page-header title="系统日志" @back="$router.go(-1)" />
    <LogTable
      :logs="logs"
      :loading="loading"
  ...
  setup() {
    ...
    const loadLogs = async (params = {}) => {
      ...
      try {
        ...
        const response = await http.get(`${API_BASE}/logs/db/system`, { params: logParams })
    ...
    const viewLogDetails = (log) => {
      console.log('查看系统日志详情:', log)
      ElMessage.info('系统日志详情功能开发中...')
    }
