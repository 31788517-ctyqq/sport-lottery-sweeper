...
const apiEndpoints = ref([
  { id: 1, path: '/api/admin/system/status', method: 'GET', status: '正常', requests: 1200 },
  { id: 2, path: '/api/admin/system/config', method: 'GET', status: '正常', requests: 850 },
  { id: 3, path: '/api/admin/system/clear-cache', method: 'POST', status: '正常', requests: 45 },
  { id: 4, path: '/api/admin/system/backup/database', method: 'POST', status: '正常', requests: 18 },
  { id: 5, path: '/api/admin/system/api/endpoints', method: 'GET', status: '正常', requests: 320 }
])
