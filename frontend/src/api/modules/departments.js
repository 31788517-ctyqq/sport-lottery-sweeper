...
export const addDepartmentMembers = (id, userIds) => {
  return http.post(`/api/v1/admin/departments/${id}/members`, { userIds })
}
...
export const batchRemoveDepartmentMembers = (departmentId, userIds) => {
  return http.delete(`/api/v1/admin/departments/${departmentId}/members/batch`, { data: { userIds } })
}
...
export const exportDepartments = (params) => {
  return http.get('/api/v1/admin/departments/export', { params, responseType: 'blob' })
}
...
export const importDepartments = (file) => {
  ...
  return http.post('/api/v1/admin/departments/import', formData, {
    headers: {
