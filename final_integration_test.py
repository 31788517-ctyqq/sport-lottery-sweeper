    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                await page.screenshot(path='final_integration_test_creation_failed.png')
                return  # 如果创建失败则退出测试
            ...
            # 选择"球员信息"选项，这是在"情报分类"组里的，位于"体育情报"之后
            ...
            try:
                ...
                await page.screenshot(path='final_integration_test_update_failed.png')
                
            print("✅ 完整集成测试流程结束")
                
        except Exception as e:
            print(f"测试过程中出现错误: {str(e)}")
            await page.screenshot(path='final_integration_test_error.png')
            raise e
        finally:
            await browser.close()
