...
from typing import Any, Optional, TypeVar, Callable, Dict, List, Union, overload
...
class NullSafety:
        ...
        try:
            ...
            for part in parts:
                ...
                if part.startswith("[") and part.endswith("]"):
                    ...
                    try:
                        index = int(index_str)
                        if isinstance(current_obj, (list, tuple)) and 0 <= index < len(current_obj):
    ...
    @staticmethod
    def ensure_not_null(value: Optional[T], name: str = "value", 
