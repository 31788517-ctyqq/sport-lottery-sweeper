...
class IntelligenceCollectionItem(Base):
    ...
    quality_status = Column(String(20), nullable=False, default="source_view", index=True)
    quality_score = Column(Float, nullable=False, default=0.0)
    quality_pass_reason = Column(Text, nullable=False, default="")
    quality_block_reason = Column(Text, nullable=False, default="")
    source_parser = Column(String(128), nullable=False, default="")
    article_url = Column(String(600), nullable=True)
    match_hit_terms_json = Column(Text, nullable=False, default="[]")
