...
from backend.schemas.headers import RequestHeaderCreate, RequestHeaderUpdate
...
class TestHeadersManagementAPI:
    ...
    def test_get_headers_success(self, test_client, mock_db, mock_query_result, mock_request_header):
        """测试获取请求头列表成功"""
        # 模拟查询
        mock_db.query.return_value = mock_query_result
        
        response = test_client.get("/api/v1/admin/headers", params={"page": 1, "size": 10})
    ...
    def test_get_headers_with_filters(self, test_client, mock_db, mock_query_result):
        """测试带筛选条件的请求头列表获取"""
        mock_db.query.return_value = mock_query_result
    ...
    def test_create_header_success(self, test_client, mock_db, mock_request_header):
        """测试创建请求头成功"""
        # 模拟新创建的请求头
    ...
    def test_get_header_detail_success(self, test_client, mock_db, mock_request_header):
        """测试获取单个请求头详情成功"""
        mock_db.query.return_value.filter.return_value.first.return_value = mock_request_header
    ...
    def test_update_header_success(self, test_client, mock_db, mock_request_header):
        """测试更新请求头成功"""
        mock_db.query.return_value.filter.return_value.first.return_value = mock_request_header
    ...
    def test_delete_header_success(self, test_client, mock_db, mock_request_header):
        """测试删除请求头成功"""
        mock_db.query.return_value.filter.return_value.first.return_value = mock_request_header
    ...
    def test_batch_delete_headers_success(self, test_client, mock_db, mock_request_header):
        """测试批量删除请求头成功"""
        # 模拟查询结果
        mock_headers = [mock_request_header]
        mock_db.query.return_value.filter.return_value.all.return_value = mock_headers
    ...
    def test_batch_test_headers_success(self, test_client, mock_db, mock_request_header):
        """测试批量测试请求头成功"""
        # 模拟查询结果
    ...
    def test_get_headers_stats_success(self, test_client, mock_db):
        ...
        mock_db.query.return_value.filter.return_value.count.return_value = 8  # enabled count
    ...
    def test_test_header_success(self, test_client, mock_db, mock_request_header):
        """测试单个请求头测试成功"""
        mock_db.query.return_value.filter.return_value.first.return_value = mock_request_header
