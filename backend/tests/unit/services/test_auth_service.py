...
class TestAuthenticationService:
    ...
    def test_register_user_success(self, auth_service, mock_db):
        ...
        # 模拟密码验证
        with patch(
            'backend.services.auth_service.validate_password_strength'
        ) as mock_validate:
            mock_validate.return_value = {"valid": True, "errors": []}

            # 模拟密码哈希
            with patch(
                'backend.services.auth_service.get_password_hash'
            ) as mock_hash:
    ...
    def test_register_user_already_exists(self, auth_service, mock_db):
        ...
        first_query = mock_db.query.return_value.filter.return_value
        first_query.first.return_value = existing_user
    ...
    def test_authenticate_user_success(
        ...
        # 模拟查询结果
        first_query = mock_db.query.return_value.filter.return_value
        first_query.first.return_value = sample_user
    ...
    def test_generate_tokens(
        self, mock_refresh, mock_access, auth_service, sample_user
    ):
        """测试生成令牌"""
    ...
    def test_verify_access_token_valid(self, mock_verify, auth_service):
