...
async def ultimate_test():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print("6. 使用CSS属性选择器点击分类选择器...")
            # 通过prop="category"属性定位元素
            category_select = page.locator('[prop="category"] .el-select__wrapper')
            ...
            try:
                ...
                await page.screenshot(path='ultimate_test_creation_failed.png')
                return  # 如果创建失败则退出测试
            ...
            try:
                ...
                await page.screenshot(path='ultimate_test_update_failed.png')
