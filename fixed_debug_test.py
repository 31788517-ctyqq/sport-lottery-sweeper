    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if success_msg_count > 0:
                ...
                await page.screenshot(path='fixed_debug_test_creation_failed.png')
                return  # 如果创建失败则退出测试
            ...
            try:
                ...
                await page.screenshot(path='fixed_debug_test_update_failed.png')
                
            print("✅ 修复的调试测试流程结束")
                
        except Exception as e:
            print(f"测试过程中出现错误: {str(e)}")
            await page.screenshot(path='fixed_debug_test_error.png')
            raise e
        finally:
            await browser.close()
