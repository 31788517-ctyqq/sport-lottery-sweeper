...
async def test_direct_option_click():
    """使用直接点击选项的方法"""
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                await page.screenshot(path='direct_click_test_creation_failed.png')
                return  # 如果创建失败则退出测试
            ...
            try:
                ...
                await page.screenshot(path='direct_click_test_update_failed.png')
                
            print("✅ 直接点击选项测试流程结束")
                
        except Exception as e:
            print(f"测试过程中出现错误: {str(e)}")
            await page.screenshot(path='direct_click_test_error.png')
            raise e
        finally:
            await browser.close()
...
if __name__ == "__main__":
    asyncio.run(test_direct_option_click())