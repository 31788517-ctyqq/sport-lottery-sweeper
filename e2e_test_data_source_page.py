...
def main():
    ...
    for route in page_routes:
        try:
            ...
            if route == "/admin/data-source/config":
    ...
    test_cases = [
        # 数据源列表API
        ("数据源列表", f"{BACKEND_BASE_URL}/api/v1/admin/sources?page=1&size=10", "GET"),
        
        # 数据源统计API
        ("数据源统计", f"{BACKEND_BASE_URL}/api/v1/admin/sources/stats", "GET"),
    ]
    ...
    successful_api_responses = sum(1 for _, status, _ in api_results if status in [200, 401, 404, 405])
